...
const styles = StyleSheet.create({
  ...
  readAllBtn: { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: Colors.teal[400], borderRadius: Radius.full },
  readAllText: { fontSize: FontSize.xs, color: Colors.teal[600], fontWeight: '700' },
