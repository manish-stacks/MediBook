...
let SpecialitiesController = class SpecialitiesController {
    ...
    findOne(slug) { return this.specialitiesService.findOne(slug); }
    create(dto) { return this.specialitiesService.create(dto); }
    update(id, dto) { return this.specialitiesService.update(id, dto); }
    remove(id) { return this.specialitiesService.remove(id); }
};
exports.SpecialitiesController = SpecialitiesController;
__decorate([
    (0, common_1.Get)(),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all specialities' }),
...
__decorate([
    (0, common_1.Get)(':slug'),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get speciality by slug' }),
...
exports.SpecialitiesController = SpecialitiesController = __decorate([
    (0, swagger_1.ApiTags)('Specialities'),
