...
export class MailService {
  ...
  async sendBookingConfirmation(data: {
    patientEmail: string; patientName: string; doctorName: string; speciality: string;
    clinicName: string; clinicAddress: string; date: string; time: string;
    appointmentNo: string; fee: string; paymentMode: string;
  }) {
  ...
  async sendPaymentReceipt(data: {
    email: string; name: string; amount: string; paymentId: string;
    appointmentNo: string; doctorName: string; date: string; mode: string;
  }) {
    const html = this.wrap(`
  ...
  async sendVisitComplete(data: {
    email: string; patientName: string; doctorName: string; speciality: string;
