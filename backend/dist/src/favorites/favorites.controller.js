...
let FavoritesController = class FavoritesController {
    ...
    check(userId, doctorId) {
        return this.favoritesService.checkFavorite(userId, doctorId);
    }
};
exports.FavoritesController = FavoritesController;
__decorate([
    (0, common_1.Post)('toggle/:doctorId'),
    (0, swagger_1.ApiOperation)({ summary: 'Toggle favorite doctor' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get my favorite doctors' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)('check/:doctorId'),
    (0, swagger_1.ApiOperation)({ summary: 'Check if doctor is favorited' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Param)('doctorId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
