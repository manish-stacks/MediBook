...
export declare class AdminController {
    ...
    updateDoctor(id: string, dto: any): Promise<{
        message: string;
        data: {
            id: string;
            createdAt: Date;
    ...
    getAppointments(query: any): Promise<{
        message: string;
        data: {
            appointments: ({
                doctor: {
    ...
    exportAppointments(query: any, res: Response): Promise<void>;
    getPatients(query: any): Promise<{
        message: string;
        data: {
            patients: ({
                user: {
