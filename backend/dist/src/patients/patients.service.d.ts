...
export declare class PatientsService {
    ...
    createPatient(userId: string, dto: any): Promise<{
        message: string;
        data: {
            id: string;
            isActive: boolean;
    ...
    updatePatient(userId: string, patientId: string, dto: any): Promise<{
        message: string;
        data: {
            id: string;
            isActive: boolean;
    ...
    deletePatient(userId: string, patientId: string): Promise<{
        message: string;
    }>;
    addVitals(patientId: string, doctorUserId: string, dto: any): Promise<{
        message: string;
        data: {
            id: string;
            createdAt: Date;
