...
import { UpdateDoctorDto, DoctorFilterDto } from './dto/doctor.dto';
export declare class DoctorsService {
    ...
    findByBookingUrl(bookingUrl: string): Promise<{
        message: string;
        data: {
            speciality: {
                id: string;
    ...
    updateProfile(doctorId: string, dto: UpdateDoctorDto): Promise<{
        message: string;
        data: {
            speciality: {
                id: string;
    ...
    getDoctorEarnings(doctorId: string, period?: 'week' | 'month' | 'year'): Promise<{
        message: string;
        data: {
            earnings: ({
                appointment: {
